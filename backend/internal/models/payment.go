...
type Payment struct {
	...
	RawRequest    sql.NullJSON `gorm:"type:json" json:"raw_request,omitempty"`
	RawResponse   sql.NullJSON `gorm:"type:json" json:"raw_response,omitempty"`
	WebhookResponse sql.NullJSON `gorm:"type:json" json:"webhook_response,omitempty"`
...
type PaymentLog struct {
	...
	EventData  sql.NullJSON   `gorm:"type:json" json:"event_data,omitempty"`
